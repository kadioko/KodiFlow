-- Anchor invoice periods to the lease's original start day instead of calendar month start.
...
BEGIN
  ...
  IF _months_since_start < 0 OR MOD(_months_since_start, _months) <> 0 THEN
